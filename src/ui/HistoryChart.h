...
public:
    ...
    void addEventMarker(const QString& label, const QDateTime& when);
void setMaxPoints(int points);
    private:
    void setupChart();
void updateSeries();    QChart* m_chart;    QChartView* m_chartView;    QComboBox* m_metricCombo;    QLineSeries* m_loadSeries;    QLineSeries* m_pressureSeries;    QLineSeries* m_overlaySeries;    QScatterSeries* m_eventSeries;    QValueAxis* m_axisY;    QDateTimeAxis* m_axisX;
