...
[![Version](https://img.shields.io/badge/version-2.40.0-blue.svg)](https://github.com/luizfernando1096lf-art/ramflux/releases)
...
This project follows [Semantic Versioning](https://semver.org/). The current version is **2.40.0**.

| Stream | Version |
|--------|---------|
| Latest Release | [v2.40.0](https://github.com/luizfernando1096lf-art/ramflux/releases/tag/v2.40.0) |

### v2.40.0 — Scheduler Dashboard Tab

New tab combining CPU Limiter, Process Suspender, Network QoS, and ML Engine status in grouped panels with enable status, thresholds, and process counts. First tab to show internal scheduler subsystem state.
