...
[![Version](https://img.shields.io/badge/version-2.29.0-blue.svg)](https://github.com/luizfernando1096lf-art/ramflux/releases)
...
This project follows [Semantic Versioning](https://semver.org/). The current version is **2.29.0**.

| Stream | Version |
|--------|---------|
| Latest Release | [v2.29.0](https://github.com/luizfernando1096lf-art/ramflux/releases/tag/v2.29.0) |

### v2.29.0 — Auto-Update Checker

Checks GitHub Releases API for newer versions. Accessible via Help > Check for Updates. Uses Qt6::Network for HTTPS requests.
