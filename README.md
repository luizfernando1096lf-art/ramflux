...
[![Version](https://img.shields.io/badge/version-2.24.0-blue.svg)](https://github.com/luizfernando1096lf-art/ramflux/releases)
...
This project follows [Semantic Versioning](https://semver.org/). The current version is **2.24.0**.

| Stream | Version |
|--------|---------|
| Latest Release | [v2.24.0](https://github.com/luizfernando1096lf-art/ramflux/releases/tag/v2.24.0) |
