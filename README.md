...
[![Version](https://img.shields.io/badge/version-2.30.0-blue.svg)](https://github.com/luizfernando1096lf-art/ramflux/releases)
...
This project follows [Semantic Versioning](https://semver.org/). The current version is **2.30.0**.

| Stream | Version |
|--------|---------|
| Latest Release | [v2.30.0](https://github.com/luizfernando1096lf-art/ramflux/releases/tag/v2.30.0) |

### v2.30.0 — Benchmark UI Widget

New "Benchmark" tab with a full GUI for the existing CLI benchmark engine: configurable durations, run/cancel, live progress, results display, and one-click open report folder.
